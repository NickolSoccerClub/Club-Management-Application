  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-xl font-bold text-[#0B2545]">Session Builder</h2>
              ...
              <Card className="border-[#1D4ED8]/30 border-2">
                ...
                <CardContent className="space-y-5 pt-5">
                  ...
                  <div className="flex gap-2 border-t border-gray-200 pt-4">
                    <Button variant="accent" size="sm">Save as Draft</Button>
                    <Button variant="primary" size="sm">Publish Session</Button>
                    <Button variant="secondary" size="sm">
