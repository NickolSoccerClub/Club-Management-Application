...
export default function CoachDrillLibraryPage() {
  ...
  const handleRequestDrill = () => {
    addToast("Request sent to Development Officer", "success");
  };
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 md:px-6 lg:px-8 space-y-6">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 bg-gray-50/50 py-12 px-6 text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100">
            <Target className="h-6 w-6 text-gray-400" />
          </div>
          <h3 className="mt-4 text-sm font-semibold text-[#0B2545]">No drills found</h3>
          <p className="mt-1 text-sm text-gray-500 max-w-sm">
            No drills match the current filters. Try adjusting your search or filter criteria.
          </p>
        </div>
      ) : (
        <>
